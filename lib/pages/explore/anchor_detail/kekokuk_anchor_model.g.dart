...
KekokukiAnchorModel _$KekokukiAnchorModelFromJson(Map<String, dynamic> json) => KekokukiAnchorModel(
      (json['albumUrlList'] as List<dynamic>?)?.map((e) => KekokukAnchorAlbumModel.fromJson(e as Map<String, dynamic>)).toList() ?? [],
      ...
      $enumDecodeNullable(_$KekokukiFollowStatusEnumMap, json['followFlag']) ?? KekokukiFollowStatus.unFollow,
      $enumDecodeNullable(_$KekokukOnlineStatusEnumMap, json['isOnline']) ?? KekokukOnlineStatus.offline,
      json['language'] as String? ?? 'en',
      json['languageName'] as String? ?? 'English',
      json['levelConfig'] == null ? null : KekokukAnchorLevelModel.fromJson(json['levelConfig'] as Map<String, dynamic>),
      (json['likeFlag'] as num?)?.toInt() ?? 1,
      (json['likeMeCount'] as num?)?.toInt() ?? 0,
      json['manyLanguage'] as String? ?? '',
      json['manyLanguageName'] as String? ?? '',
      (json['moments'] as List<dynamic>?)?.map((e) => KekokukAnchorMomentModel.fromJson(e as Map<String, dynamic>)).toList() ?? [],
      ...
      $enumDecodeNullable(_$KekokukSexEnumMap, json['sex']) ?? KekokukSex.female,
      json['signature'] as String? ?? '',
      json['srcNickname'] as String? ?? '',
      (json['tagList'] as List<dynamic>?)?.map((e) => e as String).toList() ?? [],
      $enumDecodeNullable(_$KekokukiAuthTypeEnumMap, json['userAuth']) ?? KekokukiAuthType.authedAnchor,
      (json['userId'] as num?)?.toInt() ?? 0,
      json['username'] as String? ?? '',
      (json['userStatus'] as num?)?.toInt() ?? 1,
      (json['wallVoList'] as List<dynamic>?)?.map((e) => KekokukAnchorGiftModel.fromJson(e as Map<String, dynamic>)).toList() ?? [],
    );

Map<String, dynamic> _$KekokukiAnchorModelToJson(KekokukiAnchorModel instance) => <String, dynamic>{
...
KekokukAnchorGiftModel _$KekokukAnchorGiftModelFromJson(Map<String, dynamic> json) => KekokukAnchorGiftModel(
...
Map<String, dynamic> _$KekokukAnchorGiftModelToJson(KekokukAnchorGiftModel instance) => <String, dynamic>{
...
KekokukAnchorMomentModel _$KekokukAnchorMomentModelFromJson(Map<String, dynamic> json) => KekokukAnchorMomentModel(
...
Map<String, dynamic> _$KekokukAnchorMomentModelToJson(KekokukAnchorMomentModel instance) => <String, dynamic>{
...
KekokukAnchorLevelModel _$KekokukAnchorLevelModelFromJson(Map<String, dynamic> json) => KekokukAnchorLevelModel(
...
Map<String, dynamic> _$KekokukAnchorLevelModelToJson(KekokukAnchorLevelModel instance) => <String, dynamic>{
...
KekokukAnchorAlbumModel _$KekokukAnchorAlbumModelFromJson(Map<String, dynamic> json) => KekokukAnchorAlbumModel(
...
Map<String, dynamic> _$KekokukAnchorAlbumModelToJson(KekokukAnchorAlbumModel instance) => <String, dynamic>{
      'id': instance.id,
      'userId': instance.userId,
      'value': instance.url,
