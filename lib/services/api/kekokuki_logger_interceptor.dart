...
class KekokukiLoggerInterceptor extends Interceptor {
  ...
  /// Print request data [Options.total]
  ...
  KekokukiLoggerInterceptor({
    ...
    this.maxWidth = 90,
    this.compact = true,
    this.logPrint = KekokukiDioLogger.d,
  });
  ...
  void _printResponseHeader(Response response) {
    ...
    _printBoxed(
        ...
        text: uri.toString());
    KekokukiDioLogger.d(
        "Response", "[$method:${response.statusCode}]: ${uri.toString()}");
  }
  ...
  void _printRequestHeader(RequestOptions options) {
    ...
    /// FileLogger
    KekokukiDioLogger.d("Request", "[$method]: ${uri.toString()}");
  }
